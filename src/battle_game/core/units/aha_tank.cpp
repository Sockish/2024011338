...
ATank::ATank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void ATank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool ATank::IsHit(glm::vec2 position) const {
...
const char *ATank::UnitName() const {
  return "Aha Tank";
}

const char *ATank::Author() const {
  return "Sockish";
}
}  // namespace battle_game::unit
